...
from db.models import Company, CoalCompanyPerformance, MiningSite, CompanyOwnership
from google_sheets.auth import createClient
from utils.dataframe_utils import castTypes, mapPeeweeToPandasFields
from utils.sync_utils import checkDeletedAndOrder, compareDBSheet, checkNewData, confirmChange, replaceCO
# %%

db = SqliteDatabase('coal_db.sqlite')
client, spreadsheet_id = createClient()

def sync_model(sheet_name:str, range:str, model:pw.ModelBase, preprocess:Callable) -> None:
